  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: '#FAF9F6' }}>
      <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.04]" xmlns="http://www.w3.org/2000/svg">
        <pattern id="leafbg2" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
          <path d="M30 5 C20 20 10 40 30 55 C50 40 40 20 30 5Z" fill="#166534"/>
        </pattern>
        <rect width="100%" height="100%" fill="url(#leafbg2)"/>
      </svg>
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <h1 className="font-serif text-3xl font-bold text-center text-gray-900 mb-2">Create Account</h1>
          <p className="text-center text-gray-500 text-sm mb-8">Join KrishiRakshak AI — it's free</p>
